...
public class ModelChiTietSanPham {
	...
	public ModelChiTietSanPham(int sanPhamCode, String tenSP, int giaNhap, 
			int giaBan, int soLuong, int giamGia,
			int loaiSPCode, String tenLoaiSP, int nhaCungCapCode, 
			String tenNhaCungCap, Date ngayNhap) {
		super();
