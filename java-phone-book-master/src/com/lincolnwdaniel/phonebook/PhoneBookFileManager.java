...
class PhoneBookFileManager {
    ...
    protected static boolean save(PhoneBook phoneBook) {
        if(phoneBook != null) {
            ...
            //Logger.debug(format("Saving phone with %s entries to %s.", phoneBook.getSize(), fileNameAndExt));
    ...
    protected static PhoneBook load(String fileName) {
        if(fileName != null && !fileName.trim().isEmpty()) {
            ...
            try {
                ...
                //fail
                Logger.debug(format("Loading phone book from %s failed.  No phone book found at that directory.",
                        fileNameWithExt));
            } catch (IOException e) {
                //fail
                e.printStackTrace();
                ...
                Logger.debug(format("Loading phone book from %s failed. " +
                        "Error deserializing data and converting to proper object.", fileNameWithExt));
            } finally {
